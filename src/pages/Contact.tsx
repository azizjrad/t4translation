          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 animate-fade-in-up">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Multiple ways to reach us - we're here to support your global
                communication needs
              </p>
            </div>
              ...
              {[
                {
                  ...
                  content: "Hammamet-Tunisia",
                  color: "from-blue-500 to-blue-600",
                },
                {
                  icon: MapPin,
                  title: "Libya Office",
                  content: "Tripoli, Dhahra Street-Libya",
                  color: "from-blue-500 to-blue-600",
                },
                {
                  icon: Phone,
                  title: "Phone Numbers",
                  content: "+218930692930\n+21652175934",
                  color: "from-blue-500 to-blue-600",
                },
                {
                  icon: Mail,
                  title: "Email & Support",
                  content:
                    "contact@t4translation.com\nmath.akrem@gmail.com\nAvailable 24/7",
                  color: "from-blue-500 to-blue-600",
                },
              ].map((contact, index) => {
                  ...
                  >
                    <Card className="h-full overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 bg-white">
                      ...
                      <CardContent className="p-8">
                        <div
                          className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${contact.color} flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                        >
