...
export const sendContactEmail = async (formData: ContactFormData): Promise<void> => {
  const templateParams = {
    ...
    to_email: import.meta.env.VITE_RECEIVER_EMAIL || 'contact@t4translation.com', // Your receiving email
...
export const sendGetStartedEmail = async (formData: GetStartedFormData): Promise<void> => {
  const templateParams = {
    from_name: formData.name,
    from_email: formData.email,
